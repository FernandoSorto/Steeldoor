...
import { createJob, getJob, updateJob } from "@/app/services/Jobs";
import React, { useEffect, useState } from "react";
import { useRouter } from "next/navigation";
import { JobDetails, SkillByName } from "../edit-job/[jobId]/types";
    ...
    return (
        <div className="flex flex-col items-center w-full p-10">
            ...
            <div className="flex mt-5">
                ...
                <button
                    onClick={() => create()}
                    className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-700 hover:to-blue-700 text-white font-bold py-2 px-4 rounded ml-2"
                >
                    Save
                </button>
            </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-lg shadow-lg justify">
                        <h2 className="text-2xl font-bold mb-4">Job Opportunity Created!</h2>
                        <button
                            onClick={closeModal}
